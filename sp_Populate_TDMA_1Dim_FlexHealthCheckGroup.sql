...
CREATE PROCEDURE dw.sp_Populate_FlexHealthCheckGroup AS
    ...
    DECLARE @tempTable AS NVARCHAR(100) = N'Analytics_DW.dw.TEMP_TDMA_1Dim_FlexHealthCheckGroup';

    -- Target table.
    DECLARE @targetTable AS NVARCHAR(100) = N'Analytics_DW.dm.TDMA_1Dim_FlexHealthCheckGroup';
    ...
    SELECT @targetCountBeforeDeletes = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_FlexHealthCheckGroup;
    ...
    SELECT @totalsourceUpdateCount = COUNT(*)
                               FROM [Analytics_DW].[dm].[TDMA_1Dim_FlexHealthCheckGroup] a 
                               INNER JOIN [Analytics_DW].[dw].[TEMP_TDMA_1Dim_FlexHealthCheckGroup] b ON (a.FlexHealthCheckGroup_VID = b.FlexHealthCheckGroup_VID and a.FHCG_SYS_SourceDB = b.FHCG_SYS_SourceDB);
    ...
    SELECT @targetCountBeforeAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_FlexHealthCheckGroup;
    ...
    SELECT @targetCountAfterAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_FlexHealthCheckGroup;
