...
CREATE PROCEDURE dw.sp_Populate_Path2PathwayIntervention AS
    ...
    DECLARE @tempTable AS NVARCHAR(100) = N'Analytics_DW.dw.TEMP_TDMA_1Dim_Path2PathwayIntervention';

    -- Target table.
    DECLARE @targetTable AS NVARCHAR(100) = N'Analytics_DW.dm.TDMA_1Dim_Path2PathwayIntervention';
    ...
    SELECT @targetCountBeforeDeletes = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_Path2PathwayIntervention;
    ...
    SELECT @totalsourceUpdateCount = COUNT(*)
                               FROM [Analytics_DW].[dm].[TDMA_1Dim_Path2PathwayIntervention] a 
                               INNER JOIN [Analytics_DW].[dw].[TEMP_TDMA_1Dim_Path2PathwayIntervention] b ON (a.Path2PathwayIntervention_OID = b.Path2PathwayIntervention_OID and a.SYS_SourceDB = b.SYS_SourceDB);
    ...
    SELECT @targetCountBeforeAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_Path2PathwayIntervention;
    ...
    SELECT @targetCountAfterAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_Path2PathwayIntervention;
