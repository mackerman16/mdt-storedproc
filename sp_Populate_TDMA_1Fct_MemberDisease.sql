...
CREATE PROCEDURE dw.sp_Populate_MemberDisease AS
    ...
    DECLARE @tempTable AS NVARCHAR(100) = N'Analytics_DW.dw.TEMP_TDMA_1Fct_MemberDisease';

    -- Target table.
    DECLARE @targetTable AS NVARCHAR(100) = N'Analytics_DW.dm.TDMA_1Fct_MemberDisease';
    ...
    SELECT @targetCountBeforeDeletes = COUNT(*) FROM Analytics_DW.dm.TDMA_1Fct_MemberDisease;
    ...
    SELECT @totalsourceUpdateCount = COUNT(*)
                               FROM [Analytics_DW].[dm].[TDMA_1Fct_MemberDisease] a 
                               INNER JOIN [Analytics_DW].[dw].[TEMP_TDMA_1Fct_MemberDisease] b ON (a.TR_ID = b.TR_ID and a.MDPE_SYS_SourceDB = b.MDPE_SYS_SourceDB);
    ...
    SELECT @targetCountBeforeAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Fct_MemberDisease;
    ...
    SELECT @targetCountAfterAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Fct_MemberDisease;
