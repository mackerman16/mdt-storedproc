...
CREATE PROCEDURE dw.sp_Populate_FlexAnswerType AS
    ...
    DECLARE @tempTable AS NVARCHAR(100) = N'Analytics_DW.dw.TEMP_TDMA_1Dim_FlexAnswerType';

    -- Target table.
    DECLARE @targetTable AS NVARCHAR(100) = N'Analytics_DW.dm.TDMA_1Dim_FlexAnswerType';
    ...
    SELECT @targetCountBeforeDeletes = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_FlexAnswerType;
    ...
    SELECT @totalsourceUpdateCount = COUNT(*)
                               FROM [Analytics_DW].[dm].[TDMA_1Dim_FlexAnswerType] a 
                               INNER JOIN [Analytics_DW].[dw].[TEMP_TDMA_1Dim_FlexAnswerType] b ON (a.FlexAnswerType_OID = b.FlexAnswerType_OID and a.SYS_SourceDB = b.SYS_SourceDB);
    ...
    SELECT @targetCountBeforeAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_FlexAnswerType;
    ...
    SELECT @targetCountAfterAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_FlexAnswerType;
