...
CREATE PROCEDURE dw.sp_Populate_DevicePeripheral AS
    ...
    DECLARE @tempTable AS NVARCHAR(100) = N'Analytics_DW.dw.TEMP_TDMA_1Dim_DevicePeripheral';

    -- Target table.
    DECLARE @targetTable AS NVARCHAR(100) = N'Analytics_DW.dm.TDMA_1Dim_DevicePeripheral';
    ...
    SELECT @targetCountBeforeDeletes = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_DevicePeripheral;
    ...
    SELECT @totalsourceUpdateCount = COUNT(*)
                               FROM [Analytics_DW].[dm].[TDMA_1Dim_DevicePeripheral] a 
                               INNER JOIN [Analytics_DW].[dw].[TEMP_TDMA_1Dim_DevicePeripheral] b ON (a.DevicePeripheral_OID = b.DevicePeripheral_OID and a.SYS_SourceDB = b.SYS_SourceDB);
    ...
    SELECT @targetCountBeforeAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_DevicePeripheral;
    ...
    SELECT @targetCountAfterAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_DevicePeripheral;
