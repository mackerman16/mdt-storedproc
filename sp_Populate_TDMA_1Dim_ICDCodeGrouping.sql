...
CREATE PROCEDURE dw.sp_Populate_ICDCodeGrouping AS
    ...
    DECLARE @tempTable AS NVARCHAR(100) = N'Analytics_DW.dw.TEMP_TDMA_1Dim_ICDCodeGrouping';

    -- Target table.
    DECLARE @targetTable AS NVARCHAR(100) = N'Analytics_DW.dm.TDMA_1Dim_ICDCodeGrouping';
    ...
    SELECT @targetCountBeforeDeletes = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_ICDCodeGrouping;
    ...
    SELECT @totalsourceUpdateCount = COUNT(*)
                               FROM [Analytics_DW].[dm].[TDMA_1Dim_ICDCodeGrouping] a 
                               INNER JOIN [Analytics_DW].[dw].[TEMP_TDMA_1Dim_ICDCodeGrouping] b ON (a.ICDCodeGrouping_OID = b.ICDCodeGrouping_OID and a.SYS_SourceDB = b.SYS_SourceDB);
    ...
    SELECT @targetCountBeforeAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_ICDCodeGrouping;
    ...
    SELECT @targetCountAfterAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_ICDCodeGrouping;
