...
CREATE PROCEDURE dw.sp_Populate_DeviceSetting AS
    ...
    DECLARE @tempTable AS NVARCHAR(100) = N'Analytics_DW.dw.TEMP_TDMA_1Dim_DeviceSetting';

    -- Target table.
    DECLARE @targetTable AS NVARCHAR(100) = N'Analytics_DW.dm.TDMA_1Dim_DeviceSetting';
    ...
    SELECT @targetCountBeforeDeletes = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_DeviceSetting;
    ...
    SELECT @totalsourceUpdateCount = COUNT(*)
                               FROM [Analytics_DW].[dm].[TDMA_1Dim_DeviceSetting] a 
                               INNER JOIN [Analytics_DW].[dw].[TEMP_TDMA_1Dim_DeviceSetting] b ON (a.DeviceSetting_VID = b.DeviceSetting_VID and a.SYS_SourceDB = b.SYS_SourceDB);
    ...
    SELECT @targetCountAfterAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_DeviceSetting;
