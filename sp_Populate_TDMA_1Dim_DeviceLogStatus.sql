...
CREATE PROCEDURE dw.sp_Populate_DeviceLogStatus AS
    ...
    DECLARE @tempTable AS NVARCHAR(100) = N'Analytics_DW.dw.TEMP_TDMA_1Dim_DeviceLogStatus';

    -- Target table.
    DECLARE @targetTable AS NVARCHAR(100) = N'Analytics_DW.dm.TDMA_1Dim_DeviceLogStatus';
    ...
    SELECT @targetCountBeforeDeletes = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_DeviceLogStatus;
    ...
    SELECT @totalsourceUpdateCount = COUNT(*)
                               FROM [Analytics_DW].[dm].[TDMA_1Dim_DeviceLogStatus] a 
                               INNER JOIN [Analytics_DW].[dw].[TEMP_TDMA_1Dim_DeviceLogStatus] b ON (a.DeviceLogStatus_OID = b.DeviceLogStatus_OID and a.SYS_SourceDB = b.SYS_SourceDB);
    ...
    SELECT @targetCountBeforeAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_DeviceLogStatus;
    ...
    SELECT @targetCountAfterAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_DeviceLogStatus;
