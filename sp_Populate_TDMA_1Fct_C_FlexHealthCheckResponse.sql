...
CREATE PROCEDURE dw.sp_Populate_C_FlexHealthCheckResponse AS
    ...
    DECLARE @tempTable AS NVARCHAR(100) = N'Analytics_DW.dw.TEMP_TDMA_1Fct_C_FlexHealthCheckResponse';

    -- Target table.
    DECLARE @targetTable AS NVARCHAR(100) = N'Analytics_DW.dm.TDMA_1Fct_C_FlexHealthCheckResponse';
    ...
    SELECT @targetCountBeforeDeletes = COUNT(*) FROM Analytics_DW.dm.TDMA_1Fct_C_FlexHealthCheckResponse;
    ...
    SELECT @totalsourceUpdateCount = COUNT(*)
                               FROM [Analytics_DW].[dm].[TDMA_1Fct_C_FlexHealthCheckResponse] a 
                               INNER JOIN [Analytics_DW].[dw].[TEMP_TDMA_1Fct_C_FlexHealthCheckResponse] b ON (a.TR_ID = b.TR_ID and a.SYS_SourceDB = b.SYS_SourceDB);
    ...
    SELECT @targetCountBeforeAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Fct_C_FlexHealthCheckResponse;
    ...
    SELECT @targetCountAfterAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Fct_C_FlexHealthCheckResponse;
