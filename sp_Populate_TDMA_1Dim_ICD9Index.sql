...
BEGIN
    ...
    DECLARE @constructedInsert AS NVARCHAR(4000) = N'INSERT INTO ' + @table + 
      ...
      FROM ' + @dbname + N'_DW.dm.TDMA_1Dim_ICD9Index
...
CREATE PROCEDURE dw.sp_Populate_ICD9Index AS
    ...
    DECLARE @tempTable AS NVARCHAR(90) = N'Analytics_DW.dw.TEMP_TDMA_1Dim_ICD9Index';

    -- Target table.
    DECLARE @targetTable AS NVARCHAR(90) = N'Analytics_DW.dm.TDMA_1Dim_ICD9Index';
    ...
    SELECT @targetCountBeforeDeletes = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_ICD9Index;
    ...
    SELECT @totalsourceUpdateCount = COUNT(*)
                               FROM [Analytics_DW].[dm].[TDMA_1Dim_ICD9Index] a 
                               INNER JOIN [Analytics_DW].[dw].[TEMP_TDMA_1Dim_ICD9Index] b ON (a.ICD9Index_OID = b.ICD9Index_OID and a.SYS_SourceDB = b.SYS_SourceDB);
    ...
    SELECT @targetCountBeforeAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_ICD9Index;
    ...
    SELECT @targetCountAfterAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_ICD9Index;
