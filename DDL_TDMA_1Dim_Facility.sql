...
/****** Object:  Table [dm].[TDMA_1Dim_Facility]    Script Date: 6/27/2018 11:22:03 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dm].[TDMA_1Dim_Facility](
 ...
 CONSTRAINT [PK_TDMA_1Dim_Facility] PRIMARY KEY CLUSTERED 
(
      [Facility_VID] ASC,
      [SYS_SourceDB] ASC
