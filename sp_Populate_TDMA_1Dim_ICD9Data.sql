...
CREATE PROCEDURE dw.sp_Populate_ICD9Data AS
    ...
    DECLARE @tempTable AS NVARCHAR(90) = N'Analytics_DW.dw.TEMP_TDMA_1Dim_ICD9Data';

    -- Target table.
    DECLARE @targetTable AS NVARCHAR(90) = N'Analytics_DW.dm.TDMA_1Dim_ICD9Data';
    ...
    SELECT @targetCountBeforeDeletes = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_ICD9Data;
    ...
    SELECT @totalsourceUpdateCount = COUNT(*)
                               FROM [Analytics_DW].[dm].[TDMA_1Dim_ICD9Data] a 
                               INNER JOIN [Analytics_DW].[dw].[TEMP_TDMA_1Dim_ICD9Data] b ON (a.ICD9Data_OID = b.ICD9Data_OID and a.SYS_SourceDB = b.SYS_SourceDB);
    ...
    SELECT @targetCountBeforeAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_ICD9Data;
    ...
    SELECT @targetCountAfterAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_ICD9Data;
