...
CREATE PROCEDURE dw.sp_Populate_Member_MemberDetail AS
    ...
    DECLARE @tempTable AS NVARCHAR(100) = N'Analytics_DW.dw.TEMP_TDMA_1Dim_Member_MemberDetail';

    -- Target table.
    DECLARE @targetTable AS NVARCHAR(100) = N'Analytics_DW.dm.TDMA_1Dim_Member_MemberDetail';
    ...
    SELECT @targetCountBeforeDeletes = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_Member_MemberDetail;
    ...
    SELECT @totalsourceUpdateCount = COUNT(*)
                               FROM [Analytics_DW].[dm].[TDMA_1Dim_Member_MemberDetail] a 
                               INNER JOIN [Analytics_DW].[dw].[TEMP_TDMA_1Dim_Member_MemberDetail] b ON (a.Member_VID = b.Member_VID and a.SYS_SourceDB = b.SYS_SourceDB);
    ...
    SELECT @targetCountBeforeAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_Member_MemberDetail;
    ...
    SELECT @targetCountAfterAdditions = COUNT(*) FROM Analytics_DW.dm.TDMA_1Dim_Member_MemberDetail;
